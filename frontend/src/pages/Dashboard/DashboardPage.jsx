          ...
          >
            ...
            <div className="w3-text-black w3-margin-top">
              ...
              <div className="w3-row-padding justify-content-center w3-white align-items-center ">
                {/*Start Left Column*/}
                <div className="w3-quarter flex-column justify-content-center align-items-center shadow border border-3 rounded">
                  <div className="w3-content w3-padding-large">
                    <div className="w3-display-container w3-padding-16">
                      ...
                      />
                      <div className="w3-display-bottomleft w3-padding-16 w3-container fw-bold"> 
                        <h4
                          className="w3-margin-bottom"
                          style={{ color: "#FF000C", fontFamily:'Great Vibes',  fontWeight: '100', fontSize: "32px", textShadow: "0px 3px 2px  #ffffff" }}
                        >
                          Carol Wargo
                        </h4>
                      </div>
                ...
                <div className="w3-half flex-column justify-content-center align-items-center">
                  <div className="w3-content w3-light-gray w3-padding-large shadow border border-3 rounded">
                    <div  className="w3-padding-16 text-black">
                    <h2>
    ...
    {/*End Middle Column*/}
     ...
     <div className="w3-display-container w3-padding-16">
                      <img
                        ...
                        className="w3-hover-opacity-off"
                      />
                      <div className="w3-display-bottomleft w3-padding-16 w3-container w3-text-white">
                        <h4
                          className="w3-margin-bottom"
                          style={{ color: "#FF000C", fontSize: "20px", textShadow: "0px 1px 1px  #000000" }}
                        >
                          Carol Wargo
                        </h4>
                      </div>
